...
internal object StatusContract {
    ...
    const val ACTION_SETTINGS_CHANGED = "com.example.admutetv.SETTINGS_CHANGED"
    ...
    fun settingsChangedIntent(context: Context): Intent = Intent(ACTION_SETTINGS_CHANGED)
        .setPackage(context.packageName)
}
